...
import com.zuoni.qrcode.zxing.decoding.CaptureActivityHandler;
import com.zuoni.qrcode.zxing.decoding.InactivityTimer;
import com.zuoni.qrcode.zxing.decoding.RGBLuminanceSource;
import com.zuoni.qrcode.zxing.decoding.Utils;
import com.zuoni.qrcode.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    public void getPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA}, 1);//自定义的code
        }
    }

    private void initView() {
        //返回按钮
        findViewById(R.id.ivBack).setOnClickListener(
                new OnClickListener() {
                    @Override
        ...
        ivLight = (ImageView) findViewById(R.id.mo_scanner_light);
    ...
    protected void light() {
        if (isLight) {
            ...
            ivLight.setImageResource(R.drawable.scan_light_off);

        } else {
            isLight = true;
            CameraManager.get().offLight(); // 关闪光灯
            ivLight.setImageResource(R.drawable.scan_light_on);
        }
    }
    ...
    private void initBeepSound() {
        if (playBeep && mediaPlayer == null) {
            ...
            AssetFileDescriptor file = getResources().openRawResourceFd(R.raw.scan_beep);
            try {
